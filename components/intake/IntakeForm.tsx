  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      saveReport(reportId, {
        ...
        normalized_signals: analysisPayload.normalized_signals,
        ...
        signal_strength: analysisPayload.signal_strength,
        market_gaps: analysisPayload.market_gaps,
        positioning_strategy: analysisPayload.positioning_strategy,
        recommended_move: analysisPayload.recommended_move,
        executive_summary: analysisPayload.executive_summary,
        ...
        ai_confidence_score: analysisPayload.ai_confidence_score,
        synthesis_depth: analysisPayload.synthesis_depth,
        reasoning_quality: analysisPayload.reasoning_quality,
